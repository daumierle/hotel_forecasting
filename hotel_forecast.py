...
def stationary_transform(daily, train_len, valid):
    ...
    return data_boxcox_diff, data_boxcox, train_boxcox, valid_boxcox, train_boxcox_diff, valid_boxcox_diff, fitted_lambda
...
if __name__ == '__main__':
    ...
    data_boxcox_diff, data_boxcox, train_boxcox, valid_boxcox, train_boxcox_diff, valid_boxcox_diff, fitted_lambda = stationary_transform(daily, train_len, valid)
